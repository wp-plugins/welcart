...
$devide_item = $this->options['devide_item'];
...
<table class="form_table">
	<tr height="50">
	    <th><a style="cursor:pointer;" onclick="toggleVisibility('ex_devide_item');">表示モード</a></th>
		<?php $checked = $devide_item == 1 ? ' checked="checked"' : ''; ?>
		<td width="10"><input name="devide_item" type="checkbox" id="devide_item" value="<?php echo $devide_item; ?>"<?php echo $checked; ?> /></td>
		<td width="300"><label for="devide_item">ループ表示の際、商品を分離して表示する</label></td>
	    <td><div id="ex_devide_item" class="explanation">ショップにて、複数の投稿が表示されるループ表示の際、商品データを表示させるかどうかを設定します。</div></td>
	</tr>
</table>
<table class="form_table">
	<tr height="50">
